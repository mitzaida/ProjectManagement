...
public class Uso_2_Empleado {
    ...
    private static ArrayList<Empleado> datosPersonalesEmpleado;
    private static ArrayList<Empleado> nombreAreaVarTipoArrayList ;

    public static void main(String[] args) {

        // Uso el constructor por defecto de la clase ArrayList, en este caso de tipo Empleado.
        nombreAreaVarTipoArrayList = new ArrayList<Empleado>();
        datosPersonalesEmpleado = new ArrayList<Empleado>();
...
//        nombreAreaVarTipoArrayList.set(5 , new Empleado2(4 , null));
        ...
        nombreAreaVarTipoArrayList.add(new Empleado(0,"Ventas"));
        nombreAreaVarTipoArrayList.add(new Empleado(1,"Compras"));
        nombreAreaVarTipoArrayList.add(new Empleado(2,"Atención al C."));
        nombreAreaVarTipoArrayList.add(new Empleado(3,"Facturcn."));
        nombreAreaVarTipoArrayList.add(new Empleado(4,"Entregas_all"));
...
//        nombreAreaVarTipoArrayList.set(4 , new Empleado2(4,"Entrega"));
        ...
        datosPersonalesEmpleado.add(new Empleado("Machy 0 ", 45, 5000, 4));
        datosPersonalesEmpleado.add(new Empleado("Machy 1 ", 47, 7000,1));
        datosPersonalesEmpleado.add(new Empleado("Machy 2 ", 49, 9000,3));
        datosPersonalesEmpleado.add(new Empleado("Machy 3 ", 51, 51000,0));
        datosPersonalesEmpleado.add(new Empleado("Machy 4 ", 52, 52000,2));
        ...
        for (int z1 = 0 ; z1 < nombreAreaVarTipoArrayList.size() ; z1++) {
            Empleado variableUnoTipoEmpleado = datosPersonalesEmpleado.get(z1);// vienen datos y cod area q no deberia

            int mz5 = variableUnoTipoEmpleado.getCodArea();

            Empleado variableDosTipoEmpleado = nombreAreaVarTipoArrayList.get(mz5);

            System.out.println(variableUnoTipoEmpleado.buscaDatosPer()+ " " +
                    variableDosTipoEmpleado.buscaDes());
        }
